...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).price(DEFAULT_PRICE).qty(DEFAULT_QTY);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).price(UPDATED_PRICE).qty(UPDATED_QTY);
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).qty(UPDATED_QTY);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).price(UPDATED_PRICE).qty(UPDATED_QTY);
