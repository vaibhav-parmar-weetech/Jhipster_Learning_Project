            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('orderQty')}>
                  Order Qty <FontAwesomeIcon icon={getSortIconByFieldName('orderQty')} />
                </th>
                <th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/order-product/${orderProduct.id}/delete`)}
                        color="danger"
                        size="sm"
